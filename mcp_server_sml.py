...
if __name__ == "__main__":
    ...
    if port:
        ...
        # mcp.run(transport="streamable-http") auto-serves at /mcp on the given port.
        # Smithery connects to https://your-url.railway.app/mcp — this is it.
        # No custom routing needed — FastMCP handles everything internally.
